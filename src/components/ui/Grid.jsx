...
export const BentoGrid = ({ className, children }) => {
  return (
    <div
      className={cn(
        "grid md:auto-rows-[18rem] grid-cols-1 md:grid-cols-3 gap-4 md:max-w-7xl mx-0 md:mx-auto ",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({ className, title, description, image }) => {
  return (
    ...
    >
      ...
      <div className="">
        <div className="font-sans font-bold line-clamp-1 text-neutral-600 mb-2 mt-2">
          {title}
        </div>
