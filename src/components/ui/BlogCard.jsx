...
const BlogCard = ({ image, category, readTime, title, description }) => {
  return (
    <div className="py-6 px-2 lg:px-6 bg-transparent text-left flex flex-col lg:flex-row gap-4 h-full hover:bg-gray-100/70 hover:shadow rounded-2xl">
