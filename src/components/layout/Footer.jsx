...
const Footer = () => {
  return (
    <footer className=" bg-cream/30 shadow-lg shadow-secondary/10 p-10">
      <div className="max-w-7xl mx-auto flex flex-col flex-wrap sm:flex-row items-center text-center gap-0">
