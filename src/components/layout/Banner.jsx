...
const Banner = () => {
  return (
    <div className="relative isolate h-[5vh] flex items-center gap-x-6 text-sm font-outfit overflow-hidden bg-secondary px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
