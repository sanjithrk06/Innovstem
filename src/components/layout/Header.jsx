      ...
      <div className="max-w-screen-2xl px-16 flex flex-row flex-wrap items-center justify-between mx-auto lg:mx-auto py-6">
        ...
        <div className=" xl:hidden flex flex-row gap-4">
          ...
          <button
            onClick={toggleMenu}
            type="button"
            className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg xl:hidden 
        ...
        <div
          className={`${
            isMenuOpen
              ...
              : "opacity-0 max-h-0 xl:opacity-100 xl:max-h-96"
          } w-full xl:block xl:w-auto overflow-hidden transition-all duration-500 ease-in-out`}
          id="navbar-solid-bg"
        >
          <ul className="flex flex-col font-medium mt-4 rounded-lg bg-transparent text-center xl:space-x-8 rtl:space-x-reverse xl:flex-row xl:-mt-1 xl:border-0 xl:bg-transparent gap-2">
            <li
              className="transform transition-all duration-300 hover:translate-x-1 xl:hover:translate-x-0 pt-2"
              onClick={closeMenu}
            >
              <NavLink
                to={"/"}
                className={({ isActive }) =>
                  `block py-2 px-3 xl:p-0 rounded relative transform transition-all duration-300 ease-in-out 
                    group ${
                      isActive
                        ? "text-primary bg-green-50/60 xl:bg-transparent xl:text-primary"
                        : "text-text/90 hover:bg-primary xl:hover:bg-transparent xl:hover:text-primary nav-content"
                    }`
                }
              >
                Home
                <span
                  className={`absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 ease-out 
                                 group-hover:w-full xl:opacity-0 xl:group-hover:opacity-100 `}
                ></span>
              </NavLink>
            </li>
            <li
