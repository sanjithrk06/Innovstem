        ...
        <div className="gap-20 items-center py-16 px-8 mx-auto max-w-screen-xl flex lg:flex-row flex-col-reverse lg:py-24 lg:px-6">
          ...
          <div className="font-light text-gray-500 sm:text-lg text-left lg:w-3/5">
            ...
            <p className="font-publicsans text-lg font-normal text-slate-500 mb-4 text-justify">
              ...
              for tomorrow. By focusing on skills development, personalized
              career guidance, and holistic training, we empower students from
              classes 6 to 12 to excel academically, professionally, and
              personally.
            </p>
            <p className="font-publicsans text-lg font-normal text-slate-500 mb-4 text-justify">
              Our goal is to help students discover their unique talents,
              prepare for future careers, and thrive in all aspects of life.
              Together, we are shaping a generation ready to succeed and
