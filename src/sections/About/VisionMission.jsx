        ...
        <div className=" backdrop-blur-2xl h-full">
          <section className="relative container px-4 bg-transparent my-0 py-16">
            <div className=" flex flex-col lg:flex-row gap-16">
              <div className=" group flex flex-col justify-center items-center gap-4 bg-gray-200/40 border-2 border-gray-300 backdrop-blur-3xl rounded-xl p-10">
                <div className=" border-2 border-dashed border-secondary rounded-full p-1">
