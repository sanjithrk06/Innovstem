            ...
            >
              {courses.map((item, index) => (
                <SwiperSlide key={index} className="">
                  <div className=" bg-gray-100 p-5 mb-8 rounded-xl">
                    ...
                    <a
                      href="#"
                      class=" flex cursor-pointer uppercase font-publicsans text-sm font-medium text-primary justify-end hover:underline hover:underline-offset-4 duration-300 group "
                    >
                      <button className=" bg-primary/20 p-2 px-3 rounded-2xl">
                        View Courses
                      </button>
                    </a>
                  </div>
